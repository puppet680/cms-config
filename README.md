...
更新时间：`2026-06-30 17:47:34` (基于状态码 200 活跃预检)
...
| ❌ 失效 | 豆瓣 | `https://caiji.dbzy5.com/api.php/provide/vod` | ❌ | 0 | 1 | **0.0%** | ❌ |
| ❌ 失效 | 茅台 | `https://caiji.maotaizy.cc/api.php/provide/vod` | ❌ | 0 | 1 | **0.0%** | ❌ |
